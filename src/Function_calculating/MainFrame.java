...
public class MainFrame  extends JFrame {
    ...
    public Double calculate1(Double x, Double y, Double z) {
        return (Math.pow(1/x, 1/2) + Math.cos(Math.exp(y)) + Math.cos(z*z))/(Math.pow((Math.log(1+2*z+z*z) + Math.sqrt(Math.exp(Math.cos(y)) + Math.pow(Math.sin(3.14159265359 * x), 2))),1/3));
    }
        ...
        buttonM.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ev) {
                try {
                    ...
                    JOptionPane.showMessageDialog(MainFrame.this, "Float number record error", "Number format error", JOptionPane.WARNING_MESSAGE);
                }
            }
        });
        ...
        buttonCalc.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ev) {
                try {
                    ...
                    JOptionPane.showMessageDialog(MainFrame.this, "ERROR: float number record", "ERROR: number format", JOptionPane.WARNING_MESSAGE);
                }
            }
        });
